...
export const productCategories = [
  {
    ...
    description: "24V and 48V hybrid inverter platforms with MPPT charging and lithium battery support.",
  },
  {
    id: "pump" as const,
...
export const products: Product[] = [
  ...
  {
    slug: "yj-4kw-24v-inverter",
    category: "hybrid",
    categoryLabel: "Hybrid Solar Inverter",
    name: "YJ-4.0KW/24V Inverter",
    shortName: "YJ 4.0kW",
    range: "4.0kW / 24V",
    ...
    specs: [
      ...
      ["Battery voltage", "24V"],
      ["MPPT input current / power", "18A / 5,000W"],
      ["MPPT input voltage range", "40-450V"],
      ["Maximum PV open-circuit voltage", "500V"],
      ["PV charge current", "100A"],
      ["AC charge current", "100A"],
      ["Maximum charge current", "100A"],
      ["Supported battery types", "Gel, lead-acid and lithium"],
      ["Lithium battery activation", "AC and PV"],
      ["Communication", "USB (Wi-Fi); RJ45 (CAN / RS485)"],
      ["Output channels", "Single output"],
      ["Working temperature", "-10°C to 60°C"],
      ["Carton size", "470 x 335 x 150mm"],
      ["Net / gross weight", "5.67kg / 6.31kg"],
      ["Warranty", "2 years"],
    ],
    features: ["Single output channel", "Gel, lead-acid and lithium battery support", "Lithium battery activation by AC and PV", "USB (Wi-Fi) and RJ45 communication"],
  },
  {
