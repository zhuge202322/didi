...
export default function AboutPage() {
  return (
    <main className="renewal-about-page">
      ...
      <section className="renewal-gallery"><div className="renewal-shell renewal-about-gallery">{[1,2,3,4].map((index) => <figure key={index}><Image src={`/new-site/factory-${index}.png`} alt={`Manufacturing and office environment ${index}`} fill sizes="(max-width: 700px) 100vw, 50vw" /></figure>)}</div></section>
