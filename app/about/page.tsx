  ...
  return (
    <main className="renewal-about-page">
      <section className="renewal-about-hero">
        <Image src="/new-site/about-background.png" alt="YnJoy renewable energy project team" fill priority sizes="100vw" />
      ...
      <section className="renewal-gallery"><div className="renewal-shell renewal-about-gallery">{[1,2,3,4,5,6].map((index) => <figure key={index}><Image src={`/new-site/factory-${index}.png`} alt={`Manufacturing and office environment ${index}`} fill sizes="(max-width: 700px) 100vw, 50vw" /></figure>)}</div></section>
